                ...
                <section id="contact">
                    ...
                    @include('partials.errors')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div>
                                    <input name="name" type="text" id="name" placeholder="Votre nom" required="required" value="{{old('name')}}" />
                                </div>
                            </div>
    
                            <div class="col-md-6">
                                <div>
                                    <input name="email" type="email" id="email" placeholder="Adresse e-mail" pattern="^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$" required="required" value="{{old('email')}}" />
                                </div>
                            </div>
                        </div>
    
                        <div>
                            <input name="subject" type="text" id="subject" placeholder="Sujet" required="required" value="{{old('subject')}}"/>
                        </div>
    
                        <div>
                            <textarea name="msg" cols="40" rows="3" id="comments" placeholder="Message" spellcheck="true">{{old('msg')}}</textarea>
                        </div>
